...
import AdminReset from './components/Admin/admin.reset.password';
    ...
    <Router>
         <div>
                <Route exact path="/" >
                  ...
                  <Route path="/UserPasswordReset" exact component={UserPasswordReset}/>
                  <Route path="/About" exact component={About}/>
                  <Route path="/Admin" exact component={Admin}/>
                  <Route path="/AdminLogin" exact component={AdminLogin}/>
                  <Route path="/AdminReg" exact component={AdminReg}/>
                  <Route path="/AdminReset" exact component={AdminReset}/>
