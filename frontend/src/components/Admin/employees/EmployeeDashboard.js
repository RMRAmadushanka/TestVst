                ...
                <hr/>
                    ...
                    <div className="container-fluid bg-white" style={{paddingLeft:'5%', paddingTop:'2%' ,paddingBottom:'2%', paddingRight:'5%'}} >
                     ...
                     <div className="text-end mt-5">
                       <a href="EmployeeAddStepone">
                        <MDBBtn className='btn-sm' style={{ fontSize:'18px', fontWeight:'dark'}} rounded outline color="danger" size="lg">
                            Add New Employee
                        </MDBBtn>{' '}
                       </a>
                        ...
                        <MDBTableBody>
                          {Employees.map((Employee,key) => (
                            <tr className="bg-light">
                                ...
                                <td>
                                    <MDBBtn size='lg' className="shadow-0" rounded outline color="danger" style={{fontWeight:"bold",fontSize:"14px"}} onClick={() => remove(Employee.username)}>Delete Employee</MDBBtn>{''}&nbsp;&nbsp;
                                    <MDBBtn size='lg' className="shadow-0" rounded outline color="success" style={{fontWeight:"bold",fontSize:"14px"}}   onClick={() => editEmployeeProfile(Employee.username,Employee.name,Employee.address,Employee.phone,Employee.gender,Employee.bod,Employee.nic,Employee.position,Employee.salary)}>Edit Employee</MDBBtn>
                                </td>
                            </tr>
                            ))}
                        </MDBTableBody>
                        ...
                        <MDBTableBody>
                          {PEmployees.map((PEmployee,key) => (
                            <tr className="bg-light">
                                ...
                                <td>
                                    <MDBBtn size='lg' className="shadow-0" rounded outline color="success" style={{fontWeight:"bold",fontSize:"15px"}} onClick={() => view(PEmployee.username,PEmployee.name,PEmployee.address,PEmployee.phone,PEmployee.gender,PEmployee.bod,PEmployee.nic)}>View Employee</MDBBtn>
                                </td>
                            </tr>
                            ))}
                        </MDBTableBody>
