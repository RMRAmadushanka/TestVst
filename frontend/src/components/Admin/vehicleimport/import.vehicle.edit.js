            ...
            <div  style={{paddingTop:'3%',paddingLeft:'2%', width:'98%'}}>
                ...
                <hr/>
                 <div className="container-fluid bg-white" style={{paddingLeft:'5%', paddingTop:'2%' ,paddingBottom:'2%', paddingRight:'5%'}} >
                     <center>
                         <h3 className="text-uppercase">Vehicle Update </h3>
                     </center>
                             ...
                             <div >
                                        ...
                                        <div class="mb-3">
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"  value={milage}  onChange={(e) =>{
                                                setMilage(e.target.value);
                                            }}/>
                                        </div>
                                         <div class="mb-3">
                                            <label  class="form-label h5">Menufacturering Year</label>
                                            <input type="text" class="form-control" value={m_year}  onChange={(e) =>{
                            ...
                            <MDBCardBody>
                              <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value={auctionPrice}  onChange={(e) =>{
                                                setPrice(e.target.value);
                                            }}/>
                                        </div>
                                         
                                           <div className="text-end">
                                                <button type="button" class="btn btn-success d-letter-spacing " onClick={vehicleUpdate} >Update</button>&nbsp;&nbsp;&nbsp;
