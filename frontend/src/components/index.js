        ...
        <div>
                    ...
                    <MDBRow className="mt-4">
                        <MDBCol sm='3'>
                            <a href="importVehicleUser?id=Car">
                                <div className="shopBox">
                                    <MDBCardImage position='top' src='https://image.flaticon.com/icons/png/128/1553/1553980.png' alt='...' />
                        ...
                        <MDBCol sm='3'>
                            <a href="importVehicleUser?id=Van">
                                <div className="shopBox">
                                    <MDBCardImage position='top' src='https://image.flaticon.com/icons/png/512/1896/1896745.png' alt='...' />
                        ...
                        <MDBCol sm='3'>
                            <a href="importVehicleUser?id=Bike">
                                <div className="shopBox">
                                    <MDBCardImage position='top' src='https://image.flaticon.com/icons/png/512/1168/1168041.png' alt='...' />
                        ...
                        <MDBCol sm='3'>
                            <a href="importVehicleUser?id=Heavy Vehicle">
                                <div className="shopBox">
                                    <MDBCardImage position='top' src='https://image.flaticon.com/icons/png/512/2373/2373197.png' alt='...' />
            ...
            <section className="container mt-5 pt-5 pb-5 mb-5">
                ...
                <div className="container">
                    ...
                    <div className="text-end text-capitalize mt-4">
                        <a href="" className="common-a">
                            More Vehicle Brands <MDBIcon fas icon="chevron-circle-right" />
                        </a>
                    </div>
                </div>
            </section>
