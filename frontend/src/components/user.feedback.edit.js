        ...
        <div className="container bg-light mb-5">
           <div className="p-5">
            ...
            <div className="text-end">
                <button type="submit" class="btn btn-dark btn-lg mb-3 " style={{letterSpacing:'1px'}} onClick={Edit}>Edit <MDBIcon fas icon="pencil-alt" /></button> { ' '}&nbsp;
                <a href="YourFeedback">
                     <button type="button" class="btn btn-outline-warning btn-lg mb-3" style={{letterSpacing:'1px'}}>Back</button> 
                </a>
            </div>
           </div>
        </div>
