    ...
    <div>
        ...
        <div className="container bg-white mb-3">
           <h2 className="ms-3"><br/><br/>All Customer's Feedbacks</h2>
            <a href="Feedback">
                <button type="button" class="btn btn-outline-danger btn-small mb-3 ms-3" style={{letterSpacing:'1px'}}>Back</button> 
            </a>
        </div>
                    ...
                    <div class="card shadow-0 border ms-3 me-3">
                        <div class="card-body bg-light">
                            ...
                            <div className="text-end">
                                    <button type="button" class="btn btn-dark"  onClick={() => update(Feedback._id,Feedback.start,Feedback.Feedback)}>Edit<MDBIcon fas icon="pencil-alt" /></button>{''}&nbsp;
                                    <button type="button" class="btn btn-warning" onClick={() => remove(Feedback._id)}><MDBIcon fas icon="trash-alt" /></button>
                            </div>
                        </div>
                    </div>
               </div>
