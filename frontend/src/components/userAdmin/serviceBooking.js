...
function ServiceBooking() {
  ...
  useEffect(() => {
    axios
      .get(global.APIUrl + "/serviceBooking/allServiceBooking/" + userName)
      .then((res) => setYourBooking(res.data))
      .catch((error) => console.log(error));
  });

  const [unbookings, setUnBook] = useState([]);
  useEffect(() => {
    axios
      .get(global.APIUrl + "/serviceBooking/allServiceUnBooking/" + userName)
      .then((res) => setUnBook(res.data))
      .catch((error) => console.log(error));
  });
  ...
  function save(e) {
    ...
    axios
      .post(global.APIUrl + "/serviceBooking/addServiceBooking", book)
      .then(() => {
        Swal.fire({
          title: "Success!",
          ...
          if (okay) {
            window.location.href =
              "/Payment?id=" + serviceType + "&Amount=200&paymentTitle=Booking";
          }
        });
      })
      .catch((err) => {
  ...
  function edit(
    ...
    reactLocalStorage.setObject("BookingEdit", [
      _id,
      name,
      email,
      telephone1,
    ...
    <div>
      <div className="pt-1 pb-1" style={{ backgroundColor: "#F4F4F4" }}>
        <center>
          ...
          >
            The Largest Autobile Service Hub In The Sri Lanka
          </small>
        </center>
      </div>
      <Navbar />
      ...
      <center>
        <div
          ...
          style={{ marginTop: "7%", marginBottom: "26%" }}
        >
          <div class="col-sm-8">
            <div class="card shadow-0 bg-light">
              <div class="card-body text-left">
                <center>
                  <h4 className="mt-4">Your Bookings - Request</h4>
                </center>
                <table class="table">
                  <thead>
                    ...
                    {YourBookings.map((YourBooking, key) => (
                      <tr>
                        ...
                        <td style={{ fontSize: "18px" }}>
                          <button
                            type="button"
                            class="btn btn-danger btn-sm d-letter-spacing shadow-0"
                            onClick={() =>
                              edit(
                                YourBooking._id,
                                YourBooking.name,
                ...
                <div class="mb-3">
                  ...
                  >
                    ...
                    {ServiceCenters.map((ServiceCenter, key) => (
                      <option value={ServiceCenter.location}>
